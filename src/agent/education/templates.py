...
_REQUIRED_KEYS: dict[ReportType, list[str]] = {
    ReportType.CLASS_OVERVIEW: [
        ...
        "SUBJECT_BREAKDOWN", "SUBJECT_KPI_SECTIONS", "IS_MULTI_SUBJECT", "SUBJECT_NAME",
        "SUBJECT_NAME_BADGE", "SCORE_DIST_SECTION_TITLE", "SCORE_DIST_SUBHEAD",
        "SCORE_DIST_DETAIL_TITLE",
        "RANK_INFO",
        "WEAK_KNOWLEDGE_LIST", "WEAK_KNOWLEDGE_CHART",
    ...
    ReportType.DIAGNOSTIC_REPORT: [
        ...
        "KPI_GRID", "GENERAL_INSIGHT", "REACH_TABLE", "REACH_CHART",
        "DISTRICT_SUMMARY", "BAND_TABLE", "BAND_HEATMAP", "SUBJECT_RADAR",
        "SUMMARY", "RECOMMENDATIONS",
    ],
